...
function init(){
    navigator.geolocation.getCurrentPosition(async(position) => {
        ...
        console.log(user__position.lat, user__position.lon);
    ...
    //     console.log(user__position.lat, user__position.lon);
    //     const res = await axios({
    //         url: `https://api.openweathermap.org/data/2.5/weather?units=metric&lat=${user__position.lat}&lon=${user__position.lon}&appid=${API_KEY}`,
    //         method: "GET"
    //     });
    //     const {
    //         data:{
    ...
    //             weather
    //     }, } = res;
    //     temperature.innerText = Math.floor(cur);
    //     city.innerText = cityName;
    //     console.log(icon);
    //     weatherCondition.src = `http://openweathermap.org/img/wn/${weather[0].icon}.png`
    //     console.log(res);
    // });
